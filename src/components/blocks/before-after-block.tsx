        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="border-b-4 md:border-b-0 md:border-r-4 border-black">
            ...
            <div className="relative w-full bg-gray-50" style={{ aspectRatio: "4/3" }}>
              <img src={data.before.image} alt={data.before.label} className="absolute inset-0 w-full h-full object-contain" />
            </div>
            {data.before.bullets && (
          ...
          <div>
            ...
            <div className="relative w-full bg-gray-50" style={{ aspectRatio: "4/3" }}>
              <img src={data.after.image} alt={data.after.label} className="absolute inset-0 w-full h-full object-contain" />
            </div>
            {data.after.bullets && (
              <ul className="p-4 space-y-2 border-t-2 border-black">
